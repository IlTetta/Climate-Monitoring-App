...
\item \textt{void updateOperator(RecordOperator operator)}
\end{itemize}
...
\item \textt{void performRegistration(String nameSurname, String taxCode, String email, String username, String password, Integer centerID)}
\item \textt{RecordOperator associateCenter(Integer operatorID, Integer centerID)}
\end{itemize}
...
\item \textt{public Integer score()}
