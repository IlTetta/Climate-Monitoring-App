 ...
 * @since 18/08/2024
 */
public class CitySearch extends TwoColumns implements Interfaces.UIPanel {

    /**
     * L'ID univoco per identificare questo pannello.
     */
    public static String ID = "CitySearch";
    ...
    /**
     * Costruttore della classe {@code CitySearch}.
     *
     * @param mainModel Il modello principale dell'applicazione.
     */
    public CitySearch(MainModel mainModel) {
    ...
    @Override
    public CitySearch createPanel(GUI gui) {
        this.gui = gui;
